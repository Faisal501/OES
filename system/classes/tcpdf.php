...
// TCPDF configuration
require_once(dirname(__FILE__).'/tcpdf_min/tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/tcpdf_min/include/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/tcpdf_min/include/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'/tcpdf_min/include/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'/tcpdf_min/include/tcpdf_images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'/tcpdf_min/include/tcpdf_static.php');
